/* This is the trial code with the functions to move left and right with the use of the new wheels.
* This is for Team 4890.*/
...
public class MainTeleOpTest extends LinearOpMode {
    ...
    //  We are probably going to change how we call them.
    //double rakePower;
    double liftPower;
...
//    If we use full power of the motors we are going to lose precision.
    double extraPower;
...
//            As xDirection decreases, rightPower decreases
            ...
            //New added code with right and left.
            if(gamepad1.b) {
