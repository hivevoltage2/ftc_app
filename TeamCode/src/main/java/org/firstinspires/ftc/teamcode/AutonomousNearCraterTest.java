...
//@Disabled
public class AutonomousNearCraterTest extends LinearOpMode {
    ...
    //check if below it's supposed to be "hwMap" not "ahwMap"
...
//      Below is the sequence of instructions I was talking about.
        ...
        while (runOpMode()) {
            telemetry.addData("Color Number", robot.rightColorSensor.readUnsignedByte(ModernRoboticsI2cColorSensor.Register.COLOR_NUMBER));
            telemetry update();
        }
